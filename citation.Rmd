...
- \usepackage{titlesec}
editor_options: 
  markdown: Good Afternoon!

You are a genius, your comments were super helpful. I love the idea of using the three pillars of interoperability as a framing device for section 3, and am working on adding it in. We are focusing on finishing up responses to reviewers on another publication, but we'll have a new draft for you to review by mid-to-late next week. 
...
div(id = "app_info", 
    ...
    p("Fill out the form below to generate a comprehensive food and nutrient data citation."),
...
bsPopover(id = "author_tooltip", title = "Authors of the data formatted as the surname followed by initials of first and middle names; seperate names by a comma and a space", 
